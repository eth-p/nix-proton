...
{
  name = "proton-cachyos-bin-${protonVersion}-${protonVariant}";
  version = protonVersion;

  src = fetchurl {
    inherit (downloadInfo) sha256;
    url = "${withGithubReleaseDownloadURL}/${downloadInfo.release}/${downloadInfo.file}";
  };
